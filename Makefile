...
# 
FILE_DA_CONSEGNARE=Makefile chatty.c client.c config.h connections.c connections.h \
					listener.c message.h ops.h stats.h stuffs.h \
		   			DATA/chatty.conf1 DATA/chatty.conf2  \
		   			icl_hash.c icl_hash.h script.sh relazione_545559.pdf \
...
# Aggiunto chatty.o solo per aumentare il peso di libchatty.a (Problema test3 era troppo leggero)
